...
import TourLocationPicker from '../../components/angel/TourLocationPicker';

const AngelCreateTourPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // If there's an image, we need to handle file upload
      ...
      // Create the tour
      const response = await api.post('/angel/tours', requestData);
      
      // Redirect to the tour details page
      navigate(`/angel/tour/${response.data.data.tourId}`);
    } catch (error) {
      console.error('Erro ao criar tour:', error);
      setError(
        error.response?.data?.message || 
        'Erro ao criar tour. Verifique os dados e tente novamente.'
      );
      setLoading(false);
    }
  };
  ...
  return (
    <div className="container py-4">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h1 className="h3 mb-0">Criar Novo Tour</h1>
        <Link to="/angel/tours" className="btn btn-outline-secondary">
              ...
              <div className="col-lg-4">
                ...
                <div className="card mb-3">
                  <div className="card-body">
                    ...
                    <div className="mb-3">
                      <label htmlFor="image" className="form-label">Selecionar Imagem</label>
                      <input 
                        type="file" 
                        className="form-control" 
                        id="image"
...
export default AngelCreateTourPage;